...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.66-kirby-problem-4.66-ec797cb2-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.66"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.66-kirby-problem-4.66-ec797cb2-v1",
      "problem_contract_sha256": "f48877b8aba6f3b1c64af01950f30bfcf0149207c2c49e9449a0c74661247517",
      "problem_id": "problem:um-kp-4.66-kirby-problem-4.66-ec797cb2",
      "route_id": "route:um-kp-4.66-kirby-problem-4.66-ec797cb2-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.66-kirby-problem-4.66-ec797cb2-source-fidelity-01",
      "graph_id": "graph:um-kp-4.66-kirby-problem-4.66-ec797cb2-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.66-kirby-problem-4.66-ec797cb2-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.66-kirby-problem-4.66-ec797cb2-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Can the skein lasagna module detect exotic smooth structures on closed 4-manifolds?"
          },
          "statement_sha256": "7b90b464c382095e4e513eb15a73e35fc05d1fcc298d646298827118a99f57da"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.66-kirby-problem-4.66-ec797cb2-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.66-kirby-problem-4.66-ec797cb2-root",
      "route_id": "route:um-kp-4.66-kirby-problem-4.66-ec797cb2-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.66-7be7e9339077",
        "url": "https://www.unsolvedmath.com/problems/KP-4.66"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
